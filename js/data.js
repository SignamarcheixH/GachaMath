...
const CULTE = {
  0:     { nom:'Le Vide',                emoji:'🕳️', pts:20, desc:"Il n'a pas été tiré. Il a été forgé. Le gacha ne distribue pas le néant — il faut le fabriquer soi-même." },
  1:     { nom:"L'Unité",                emoji:'☝️', pts:4,  desc:"Ni premier, ni composé. On l'a exclu des premiers par décret, parce qu'il cassait tous les théorèmes." },
  7:     { nom:'Le Chanceux',            emoji:'🍀', pts:4,  desc:"Le nombre préféré de l'humanité, toutes cultures confondues. Les sondages sont formels." },
  12:    { nom:'La Douzaine',            emoji:'🥚', pts:3,  desc:"Le nombre que le système décimal a battu de justesse. Une injustice, disent les duodécimalistes." },
  13:    { nom:'Le Malchanceux',         emoji:'🐈‍⬛', pts:4,  desc:"Des immeubles entiers sautent son étage. C'est pourtant un premier tout à fait respectable." },
  23:    { nom:'Le Complot',             emoji:'👁️', pts:4,  desc:"Tout se ramène à 23 si l'on veut bien s'en donner la peine. C'est précisément le problème." },
  42:    { nom:'La Réponse',             emoji:'🌌', pts:12, desc:"À la Grande Question sur la Vie, l'Univers et le Reste. La question, elle, reste introuvable." },
  64:    { nom:'La Cartouche',           emoji:'🎮', pts:4,  desc:"Le bit qui a marqué une génération." },
  69:    { nom:'Nice',                   emoji:'😎', pts:6,  desc:"Nice." },
  73:    { nom:'Le Meilleur Nombre',     emoji:'🤓', pts:6,  desc:"21e premier, 12 renversé, 7×3=21. Sheldon Cooper y consacre un monologue entier, et il n'a pas tort." },
  88:    { nom:'Le Grand Huit',          emoji:'🎢', pts:3,  desc:"Deux infinis empilés. Ou une DeLorean lancée à 88 mph." },
  100:   { nom:'Le Cent Pour Cent',      emoji:'💯', pts:4,  desc:"L'unité de mesure universelle de l'accomplissement." },
  101:   { nom:"Le Cours d'Intro",       emoji:'🎓', pts:4,  desc:"Palindrome, premier, et titre de tous les cours pour débutants du monde anglophone." },
  108:   { nom:'La Trappe',              emoji:'🏝️', pts:4,  desc:"4 8 15 16 23 42. Il faut saisir la séquence toutes les 108 minutes. Sinon… on ne sait pas." },
  200:   { nom:'OK',                     emoji:'✅', pts:3,  desc:"Tout va bien. Le serveur vous aime." },
  256:   { nom:"L'Octet Plein",          emoji:'🧱', pts:4,  desc:"Le mur contre lequel se sont écrasés des milliers de programmes." },
  300:   { nom:'Les Spartiates',         emoji:'🛡️', pts:3,  desc:"CE SOIR NOUS DÎNERONS AUX ENFERS." },
  314:   { nom:'Presque Pi',             emoji:'🥧', pts:5,  desc:"Assez proche pour l'ingénierie, jamais assez pour un mathématicien." },
  360:   { nom:'Le No-Scope',            emoji:'🎯', pts:4,  desc:"Un tour complet. En degrés comme en réputation." },
  404:   { nom:'Introuvable',            emoji:'🫥', pts:9, desc:"Le nombre qui désigne l'absence. Vous l'avez trouvé. C'est paradoxal." },
  418:   { nom:'Je Suis Une Théière',    emoji:'🫖', pts:10, desc:"Vrai code HTTP, issu d'un poisson d'avril de 1998, défendu depuis avec une ferveur inquiétante." },
  420:   { nom:'Blaze It',               emoji:'🌿', pts:6,  desc:"Aucun commentaire mathématique n'est requis." },
  451:   { nom:'Fahrenheit',             emoji:'🔥', pts:4,  desc:"La température à laquelle le papier s'enflamme. Et un code HTTP pour la censure." },
  500:   { nom:'Erreur Serveur',         emoji:'💥', pts:4,  desc:"Quelque chose s'est mal passé. On ne vous dira pas quoi." },
  555:   { nom:'Le Faux Numéro',         emoji:'☎️', pts:4,  desc:"L'indicatif que Hollywood utilise pour ne jamais faire sonner un vrai téléphone." },
  666:   { nom:'Le Nombre de la Bête',   emoji:'😈', pts:9, desc:"Triangulaire, ce qui est ironique pour un symbole d'infernal désordre." },
  777:   { nom:'Le Jackpot',             emoji:'🎰', pts:6,  desc:"Trois rouleaux alignés. Le gacha vous salue." },
  911:   { nom:"L'Urgence",              emoji:'🚨', pts:4,  desc:"Premier, et le numéro qu'on ne veut jamais composer." },
  999:   { nom:'La Bête Renversée',      emoji:'🙃', pts:5,  desc:"666 debout sur la tête. Ou l'urgence, côté britannique." },
  1000:  { nom:'Le Kilo',                emoji:'⚖️', pts:4,  desc:"Le seuil psychologique de tout." },
  1024:  { nom:'Le Kibi',                emoji:'📀', pts:5,  desc:"Le kilo des informaticiens, qui refusent obstinément de valoir 1000." },
  1234:  { nom:"L'Échauffement",         emoji:'🪜', pts:4,  desc:"La séquence que tout le monde tape au moins une fois." },
  1337:  { nom:'L33T',                   emoji:'🕶️', pts:10, desc:"Premier. Naturellement." },
  1492:  { nom:'La Traversée',           emoji:'⛵', pts:4,  desc:"Une erreur de navigation devenue continent." },
  1789:  { nom:'La Révolution',          emoji:'🗼', pts:4,  desc:"Premier, tronquable par la gauche, et légèrement explosif." },
  1969:  { nom:'Le Petit Pas',           emoji:'🌕', pts:4,  desc:"Un petit pas pour l'homme." },
  1984:  { nom:'La Surveillance',        emoji:'📺', pts:4,  desc:"Big Brother compte vos tirages." },
  2000:  { nom:'Le Bug',                 emoji:'🐛', pts:4,  desc:"L'apocalypse qui n'a pas eu lieu, parce que des milliers de gens ont travaillé tout l'été." },
  2026:  { nom:'Ici et Maintenant',      emoji:'📅', pts:5,  desc:"L'année en cours. Elle ne le restera pas." },
  2718:  { nom:"Le Nombre d'Euler",      emoji:'📈', pts:6,  desc:"e ≈ 2,718. La croissance dans son état le plus pur." },
  3141:  { nom:'Pi Étendu',              emoji:'🥧', pts:6,  desc:"Quatre décimales. Suffisant pour envoyer une sonde sur Mars, en fait." },
  4711:  { nom:"L'Eau de Cologne",       emoji:'🧴', pts:4,  desc:"Le numéro d'une maison de Cologne devenu parfum mondial." },
  5040:  { nom:'Le Nombre de Platon',    emoji:'🏛️', pts:6,  desc:"Platon voulait que sa cité idéale compte exactement 5040 citoyens : il a 60 diviseurs, on peut la découper comme on veut." },
  8008:  { nom:'La Calculatrice',        emoji:'🔢', pts:6,  desc:"Vous savez très bien pourquoi. Retournez l'écran." },
  9001:  { nom:'Plus de 9000',           emoji:'💢', pts:10, desc:"C'EST PLUS DE 9000 !!! (La traduction originale disait 8000. Le mème a tranché.)" },
  9999:  { nom:'Le Plafond',             emoji:'🧗', pts:6,  desc:"Le plus grand nombre que le gacha puisse tirer. Au-delà, il faut forger." },
  12345: { nom:'Le Mot de Passe',        emoji:'🔓', pts:10,  desc:"Le mot de passe d'un idiot sur ses bagages. Introuvable au tirage — il se forge." },
  65535: { nom:'Le Débordement',         emoji:'📉', pts:12, desc:"2¹⁶ − 1. Au-delà, tout recommence à zéro. Demandez à Gandhi." },
  99999: { nom:'La Frontière',           emoji:'🚧', pts:17, desc:"Le plus grand nombre forgeable. Il n'y a rien après. Vraiment rien." },
};
