...
const V = 42;                                   // version des assets, cf. index.html
...
<h2>Nous écrire</h2>
<p class="aRemplir"><b>⚠ À compléter avant la mise en ligne :</b> une adresse de contact.
Elle est exigée par AdSense, et une page « À propos » sans moyen de contact fait échouer
la demande. La même adresse doit figurer sur la page de confidentialité.</p>`;
